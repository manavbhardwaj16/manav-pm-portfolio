...
export default function About() {
  return (
    <section id="about" data-testid="about-section" className="py-24 md:py-36">
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-16 grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-20">
        <div className="lg:col-span-4">
          ...
          <div className="mt-10 border border-[var(--border)] aspect-[3/4] overflow-hidden bg-[var(--surface)] reveal">
            <img
              src="https://manavbhardwaj.lovable.app/assets/profile-Cd-bEQ4f.jpeg"
              alt="Manav Bhardwaj"
        ...
        <div className="lg:col-span-8 lg:pt-12">
          ...
          >
            ...
            <span className="font-display-italic">first PRD</span> to compliance audit, from
            empty Mixpanel dashboards to{" "}
            <span className="font-display-italic">150K users in two months</span>. My
            edge is operating where AI, fintech, and consumer growth overlap — and turning
            messy ambiguity into measurable outcomes.
          </p>
          ...
          >
            ...
            black-box automation, and treat KPI frameworks as core product surface. I work
            best on 0→1 problems and 1→10 scale-ups where the brief is unclear and the bar
            is high.
          </p>

          {/* Mini facts grid */}
          <div className="mt-14 grid grid-cols-2 md:grid-cols-4 border-t border-[var(--border)]">
            {[
